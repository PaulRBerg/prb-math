...
function div(SD59x18 x, SD59x18 y) pure returns (SD59x18 result) {
    ...
    uint256 rAbs = PRBMath.mulDiv(ax, uint256(SCALE_INT), ay);
...
function exp2(SD59x18 x) pure returns (SD59x18 result) {
    ...
    if (x.lt(ZERO)) {
        ...
        result = SD59x18.wrap(int256(PRBMath.exp2(x_192x64)));
    }
}
...
function gm(SD59x18 x, SD59x18 y) pure returns (SD59x18 result) {
    ...
    uint256 resultUint = PRBMath.sqrt(uint256(SD59x18.unwrap(xy)));
...
function log2(SD59x18 x) pure returns (SD59x18 result) {
    ...
    uint256 n = PRBMath.msb(uint256(SD59x18.unwrap(x.uncheckedDiv(SCALE))));
...
///
/// Caveats:
/// - The body is purposely left uncommented; to understand how this works, see the NatSpec comments in `PRBMath.mulDivSigned`.
///
...
function sqrt(SD59x18 x) pure returns (SD59x18 result) {
    ...
    uint256 resultUint = PRBMath.sqrt(uint256(SD59x18.unwrap(x.uncheckedMul(SCALE))));
    result = SD59x18.wrap(int256(resultUint));
}
