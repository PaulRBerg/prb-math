...
export const MAX_WHOLE_SD59x18: BigNumber = MAX_SD59x18.sub(solidityModByUnit(MAX_SD59x18));
...
export const MIN_WHOLE_SD59x18: BigNumber = MIN_SD59x18.sub(solidityModByUnit(MIN_SD59x18));
...
export const SQRT_MAX_SD59x18_DIV_BY_UNIT = bn("240615969168004511545033772477625056927");
