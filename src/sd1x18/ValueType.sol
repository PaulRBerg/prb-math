...
using { intoSD59x18, intoUD2x18, intoUD60x18, intoUint256, intoUint128, intoUint40 } for SD1x18 global;

/// @notice Casts an SD1x18 number to SD59x18.
/// @dev There is no overflow check because the domain of SD1x18 is a subset of SD59x18.
function intoSD59x18(SD1x18 x) pure returns (SD59x18 result) {
    result = SD59x18.wrap(int256(SD1x18.unwrap(x)));
}

/// @notice Casts an SD1x18 number to UD2x18.
/// - x must be positive.
...
/// @notice Casts an SD1x18 number to uint40.
/// @dev Requirements:
/// - x must be positive.
