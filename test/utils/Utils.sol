...
contract PRBMathUtils is StdUtils {
    ...
    function _bound(SD1x18 x, SD1x18 min, SD1x18 max) internal pure returns (SD1x18 result) {
        result = SD1x18.wrap(int64(_bound(int256(x.unwrap()), int256(min.unwrap()), int256(max.unwrap()))));
    }
    ...
    /// @dev Helper function to bound an SD1x18 number.
    function _bound(SD1x18 x, int64 min, SD1x18 max) internal pure returns (SD1x18 result) {
        result = SD1x18.wrap(int64(_bound(int256(x.unwrap()), int256(min), int256(max.unwrap()))));
    }
    ...
    /// @dev Helper function to bound an SD1x18 number.
    function _bound(SD1x18 x, SD1x18 min, int64 max) internal pure returns (SD1x18 result) {
        result = SD1x18.wrap(int64(_bound(int256(x.unwrap()), int256(min.unwrap()), int256(max))));
    }
    ...
    /// @dev Helper function to bound an SD1x18 number.
    function _bound(SD1x18 x, int64 min, int64 max) internal pure returns (SD1x18 result) {
        result = SD1x18.wrap(int64(_bound(int256(x.unwrap()), int256(min), int256(max))));
    }
    ...
    function _bound(SD59x18 x, SD59x18 min, SD59x18 max) internal pure returns (SD59x18 result) {
        result = SD59x18.wrap(_bound(x.unwrap(), min.unwrap(), max.unwrap()));
    }
    ...
    /// @dev Helper function to bound an SD59x18 number.
    function _bound(SD59x18 x, int256 min, SD59x18 max) internal pure returns (SD59x18 result) {
        result = SD59x18.wrap(_bound(x.unwrap(), min, max.unwrap()));
    }
    ...
    /// @dev Helper function to bound an SD59x18 number.
    function _bound(SD59x18 x, SD59x18 min, int256 max) internal pure returns (SD59x18 result) {
        result = SD59x18.wrap(_bound(x.unwrap(), min.unwrap(), max));
    }
    ...
    /// @dev Helper function to bound an SD59x18 number.
    function _bound(SD59x18 x, int256 min, int256 max) internal pure returns (SD59x18 result) {
        result = SD59x18.wrap(_bound(x.unwrap(), min, max));
    }
    ...
    function _bound(UD2x18 x, UD2x18 min, UD2x18 max) internal pure returns (UD2x18 result) {
        result = UD2x18.wrap(uint64(_bound(uint256(x.unwrap()), uint256(min.unwrap()), uint256(max.unwrap()))));
    }
    ...
    /// @dev Helper function to bound a UD2x18 number.
    function _bound(UD2x18 x, uint64 min, UD2x18 max) internal pure returns (UD2x18 result) {
        result = UD2x18.wrap(uint64(_bound(uint256(x.unwrap()), uint256(min), uint256(max.unwrap()))));
    }
    ...
    /// @dev Helper function to bound a UD2x18 number.
    function _bound(UD2x18 x, UD2x18 min, uint64 max) internal pure returns (UD2x18 result) {
        result = UD2x18.wrap(uint64(_bound(uint256(x.unwrap()), uint256(min.unwrap()), uint256(max))));
    }
    ...
    /// @dev Helper function to bound a UD2x18 number.
    function _bound(UD2x18 x, uint64 min, uint64 max) internal pure returns (UD2x18 result) {
        result = UD2x18.wrap(uint64(_bound(uint256(x.unwrap()), uint256(min), uint256(max))));
    }
    ...
    function _bound(UD60x18 x, UD60x18 min, UD60x18 max) internal pure returns (UD60x18 result) {
        result = UD60x18.wrap(_bound(x.unwrap(), min.unwrap(), max.unwrap()));
    }
    ...
    /// @dev Helper function to bound a UD60x18 number.
    function _bound(UD60x18 x, uint256 min, UD60x18 max) internal pure returns (UD60x18 result) {
        result = UD60x18.wrap(_bound(x.unwrap(), min, max.unwrap()));
    }
    ...
    /// @dev Helper function to bound a UD60x18 number.
    function _bound(UD60x18 x, UD60x18 min, uint256 max) internal pure returns (UD60x18 result) {
        result = UD60x18.wrap(_bound(x.unwrap(), min.unwrap(), max));
    }
    ...
    /// @dev Helper function to bound a UD60x18 number.
    function _bound(UD60x18 x, uint256 min, uint256 max) internal pure returns (UD60x18 result) {
        result = UD60x18.wrap(_bound(x.unwrap(), min, max));
    }
}
