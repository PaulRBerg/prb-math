...
export default function shouldBehaveLikeExp(): void {
  ...
  context("when x is negative", function () {
    context("when x is less than -41446531673892822322", function () {
    ...
    context("when x is greater than or equal to -41446531673892822322", function () {
      const testSets = [
        ...
        [fp(-2), bn("135335283236612692")],
        [fp(-1), bn("367879441171442322")],
        [fp(-0.000000000000001), bn("999999999999999001")],
